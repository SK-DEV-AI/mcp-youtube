...
var require_src2 = __commonJS((exports) => {
  var __dirname = "/home/sk/mcp-youtube/node_modules/spawn-rx/lib/src";
  ...
  return {
    tools: [
      ...
      },
      {
        ...
        description: "List all available subtitle tracks for a YouTube video, including manual and auto-generated subtitles in different languages.",
        inputSchema: {
          type: "object",
          properties: {
            url: { type: "string", description: "URL of the YouTube video" }
      ...
      },
      {
        ...
        description: "Download subtitles from a YouTube video with comprehensive options for language, format, and time range selection. Perfect for long videos where you only need subtitles for a specific portion.",
        inputSchema: {
          type: "object",
          properties: {
            url: { type: "string", description: "URL of the YouTube video" },
      ...
      },
      {
        ...
        description: "Download comprehensive metadata for a YouTube video including title, description, duration, upload date, and available formats.",
        inputSchema: {
          type: "object",
          properties: {
            url: { type: "string", description: "URL of the YouTube video" }
  ...
  try {
    switch (name) {
      ...
      case "list_available_subtitles":
        return await handleListAvailableSubtitles(request.params.arguments);
      case "download_subtitles":
        return await handleDownloadSubtitles(request.params.arguments);
...
function stripVttNonContent(vttContent, preserveTiming = false) {
  ...
  if (preserveTiming) {
    ...
    for (let i = 0;i < contentLines.length; i++) {
      ...
      if (line.includes("-->")) {
        ...
        const cleanedLine = line.replace(/<\d{2}:\d{2}:\d{2}\.\d{3}>|<\/c>/g, "").replace(/<c>/g, "").trim();
        if (cleanedLine !== "") {
