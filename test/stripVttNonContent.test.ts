...
Different line`;
  ...
  it("should preserve timing when requested", () => {
    const testVtt = `WEBVTT
Kind: captions
Language: en
...
This is a test`;
    ...
    const result = stripVttNonContent(testVtt, true);
  ...
  it("should strip timing when not preserving", () => {
    const testVtt = `WEBVTT
Kind: captions
Language: en
...
This is a test`;
    ...
    const result = stripVttNonContent(testVtt, false);
